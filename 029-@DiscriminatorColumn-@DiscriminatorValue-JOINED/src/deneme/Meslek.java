...
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS) // Sýngle -> varsayýlan -> JOIN -> birleþik -> Table_per_class tum tablolarý bir sýnýfa haritalama
...
public class Meslek {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.TABLE) // deðerleri TABLOYA GÖRE DAÐITIR.
